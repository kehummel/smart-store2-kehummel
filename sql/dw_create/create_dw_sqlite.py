...
def create_dw() -> None:
    ...
    try:
        ...
        run_sql_file(conn, SQL_DW_CREATE_DIR / "drop_all_tables.sql")
        run_sql_file(conn, SQL_DW_CREATE_DIR / "create_customers.sql")
        run_sql_file(conn, SQL_DW_CREATE_DIR / "create_products.sql")
        run_sql_file(conn, SQL_DW_CREATE_DIR / "create_sales.sql")
